...
$config->banner = '<img src="images/hotdog.svg" alt="hot-dog" width="44" style="filter: drop-shadow(8px 6px 9px rgba(0, 0, 0, 0.5));">'; #goes inside header - can be overwritten
